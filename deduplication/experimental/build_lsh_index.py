...
def parse_args():
    ...
    parser.add_argument('-t', '--tag', help='Tag, used when logging profiling information (e.g. rp1_arxiv)', required=True)
...
if __name__ == '__main__':
    ...
    data = [args.tag, avg_time_per_file, elapsed_proc_seconds, avg_file_size, file_sizes,
            n_files]
